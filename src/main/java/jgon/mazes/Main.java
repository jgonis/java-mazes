...
import jgon.mazes.drawing.CellBorderRenderer;
...
class Mazegen implements Callable<Integer> {
	...
	public Integer call() throws Exception { // your business logic goes here...
		...
		switch (algorithm) {
			...
			case MazeAlgorithm.Sidewinder -> SidewinderMazeAlgorithm.applyTo(testMaze);
		}
		testMaze.cellAt(testMaze.getRows() - 1, 0)
		        .setIsStart();
		testMaze.cellAt(0, testMaze.getColumns() - 1)
		        .setIsEnd();
		new MazeImageDrawer.Builder("test.png", new CellBorderRenderer())
				.createMazeImageDrawer()
				.drawMaze(testMaze);
		return 0;
	}
